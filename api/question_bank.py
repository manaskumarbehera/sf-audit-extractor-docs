...
QUESTIONS = [
    ...
    },
    {
        ...
        "difficulty": 2,
        "mode": ["quiz", "speed"],
        "q": "What is the best use of the launcher popup?",
        "opts": ["Run all heavy admin tasks there", "Quick entry, org context, and jump into the right tool", "Replace Salesforce Setup", "Host metadata tables"],
        "answer": 1,
        "explanation": "The launcher popup is best for <strong>quick entry and routing</strong> into the right workspace or page action.",
        "tags": ["general", "launcher", "ux", "training"],
    },
    {
        "id": "gen-009",
        "topic": "general",
        "difficulty": 2,
        "mode": ["quiz", "truefalse"],
        "q": "What does Setup Search on a Salesforce page now search?",
        "opts": ["Only Setup menu pages", "Setup pages plus metadata results such as Flows, Permission Sets, Record Types, and Apex Classes", "Only open browser tabs", "Only custom objects"],
        "answer": 1,
        "explanation": "Setup Search now covers <strong>both Setup navigation and metadata discovery</strong>, including API-name-based matches.",
        "tags": ["general", "setup-search", "metadata", "api-name"],
    },
    {
        "id": "gen-010",
        "topic": "data_explorer",
        "difficulty": 3,
        "mode": ["quiz", "scenario"],
        "q": "Why would you use Metadata Explorer after finding an item in Setup Search?",
        "opts": ["To switch browsers", "To inspect the metadata in a deeper workspace context with filtering and follow-up actions", "To clear Salesforce cache", "To open the Chrome Web Store"],
        "answer": 1,
        "explanation": "Setup Search is great for <strong>fast discovery</strong>, while Metadata Explorer is better for <strong>deeper inspection and follow-up workflow</strong> inside the workspace.",
        "tags": ["data-explorer", "metadata", "setup-search", "ux"],
    },
    {
        "id": "gen-011",
        "topic": "org_tools",
        "difficulty": 2,
        "mode": ["quiz", "scenario"],
        "q": "What is the safer admin workflow for label translations in TrackForcePro?",
        "opts": ["Edit raw records manually every time", "Use the Org Tools translation/export/import flow with fallback handling", "Only deploy from browser devtools", "Use the leaderboard export"],
        "answer": 1,
        "explanation": "TrackForcePro's <strong>Org Tools translation workflow</strong> is designed to handle creation, update, import, and fallback behavior more safely than ad hoc manual edits.",
        "tags": ["org-tools", "translations", "admin", "safety"],
    },
]
# fmt: on
